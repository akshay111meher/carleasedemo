...
contract.methods.CreateCar("MC12344",1234,"Mercedes","Model 1","Red","RegNumber",address).send({from:address,gas:3000000},function(err,result){
	console.log(result)
})

// string V5cID, uint VIN, string Make, string Model, string Color, string Reg, address Owner